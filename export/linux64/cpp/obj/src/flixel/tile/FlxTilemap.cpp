...
bool UpdateWorld = __o_UpdateWorld.Default(true);
	HX_STACK_FRAME("flixel.tile.FlxTilemap","follow",0xe6a96c35,"flixel.tile.FlxTilemap.follow","flixel/tile/FlxTilemap.hx",1297,0x448feb74)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Camera,"Camera")
...
::flixel::util::FlxRect FlxTilemap_obj::getBounds( ::flixel::util::FlxRect Bounds){
	HX_STACK_FRAME("flixel.tile.FlxTilemap","getBounds",0x86b34767,"flixel.tile.FlxTilemap.getBounds","flixel/tile/FlxTilemap.hx",1313,0x448feb74)
	HX_STACK_THIS(this)
...
Float Resolution = __o_Resolution.Default(1);
	HX_STACK_FRAME("flixel.tile.FlxTilemap","ray",0xbe0558a6,"flixel.tile.FlxTilemap.ray","flixel/tile/FlxTilemap.hx",1333,0x448feb74)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Start,"Start")
	HX_STACK_ARG(End,"End")
...
Float Resolution = __o_Resolution.Default(1);
	HX_STACK_FRAME("flixel.tile.FlxTilemap","rayHit",0xabd2114d,"flixel.tile.FlxTilemap.rayHit","flixel/tile/FlxTilemap.hx",1447,0x448feb74)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Start,"Start")
	HX_STACK_ARG(End,"End")
	HX_STACK_ARG(Resolution,"Resolution")
...
{
		HX_STACK_FRAME("flixel.tile.FlxTilemap","updateFrameData",0x0334926a,"flixel.tile.FlxTilemap.updateFrameData","flixel/tile/FlxTilemap.hx",1555,0x448feb74)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1555)
...
int NewTile = __o_NewTile.Default(0);
	HX_STACK_FRAME("flixel.tile.FlxTilemap","tileToFlxSprite",0x2b66754a,"flixel.tile.FlxTilemap.tileToFlxSprite","flixel/tile/FlxTilemap.hx",1581,0x448feb74)
	HX_STACK_THIS(this)
	HX_STACK_ARG(X,"X")
	HX_STACK_ARG(Y,"Y")
...
{
		HX_STACK_FRAME("flixel.tile.FlxTilemap","updateBuffers",0xf5face26,"flixel.tile.FlxTilemap.updateBuffers","flixel/tile/FlxTilemap.hx",1640,0x448feb74)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1641)
		int i = (int)0;		HX_STACK_VAR(i,"i");
		HX_STACK_LINE(1642)
...
{
		HX_STACK_FRAME("flixel.tile.FlxTilemap","drawTilemap",0x2b20d346,"flixel.tile.FlxTilemap.drawTilemap","flixel/tile/FlxTilemap.hx",1667,0x448feb74)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.tile.FlxTilemap","simplifyPath",0x8a506712,"flixel.tile.FlxTilemap.simplifyPath","flixel/tile/FlxTilemap.hx",1855,0x448feb74)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.tile.FlxTilemap","raySimplifyPath",0xc5bc2714,"flixel.tile.FlxTilemap.raySimplifyPath","flixel/tile/FlxTilemap.hx",1888,0x448feb74)
		HX_STACK_THIS(this)
		HX_STACK_ARG(Points,"Points")
		HX_STACK_LINE(1889)
...
Array< int > FlxTilemap_obj::computePathDistance( int StartIndex,int EndIndex,bool WideDiagonal){
	HX_STACK_FRAME("flixel.tile.FlxTilemap","computePathDistance",0x95b706cd,"flixel.tile.FlxTilemap.computePathDistance","flixel/tile/FlxTilemap.hx",1930,0x448feb74)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.tile.FlxTilemap","walkPath",0xd33d3b12,"flixel.tile.FlxTilemap.walkPath","flixel/tile/FlxTilemap.hx",2110,0x448feb74)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.tile.FlxTilemap","updateTile",0x18c3429b,"flixel.tile.FlxTilemap.updateTile","flixel/tile/FlxTilemap.hx",2209,0x448feb74)
		HX_STACK_THIS(this)
		HX_STACK_ARG(Index,"Index")
		HX_STACK_LINE(2210)
...
{
		HX_STACK_FRAME("flixel.tile.FlxTilemap","autoTile",0xabb4ce01,"flixel.tile.FlxTilemap.autoTile","flixel/tile/FlxTilemap.hx",2244,0x448feb74)
		HX_STACK_THIS(this)
		HX_STACK_ARG(Index,"Index")
		HX_STACK_LINE(2245)
...
bool FlxTilemap_obj::set_forceComplexRender( bool Value){
	HX_STACK_FRAME("flixel.tile.FlxTilemap","set_forceComplexRender",0x65b6293c,"flixel.tile.FlxTilemap.set_forceComplexRender","flixel/tile/FlxTilemap.hx",2302,0x448feb74)
	HX_STACK_THIS(this)
...
Float FlxTilemap_obj::set_scaleX( Float Scale){
	HX_STACK_FRAME("flixel.tile.FlxTilemap","set_scaleX",0x433c858f,"flixel.tile.FlxTilemap.set_scaleX","flixel/tile/FlxTilemap.hx",2321,0x448feb74)
	HX_STACK_THIS(this)
...
Float FlxTilemap_obj::set_scaleY( Float Scale){
	HX_STACK_FRAME("flixel.tile.FlxTilemap","set_scaleY",0x433c8590,"flixel.tile.FlxTilemap.set_scaleY","flixel/tile/FlxTilemap.hx",2345,0x448feb74)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Scale,"Scale")
	HX_STACK_LINE(2346)
	Scale = ::Math_obj::abs(Scale);
