...
Float FlxEase_obj::cubeOut( Float t){
	HX_STACK_FRAME("flixel.tweens.FlxEase","cubeOut",0x9017cc97,"flixel.tweens.FlxEase.cubeOut","flixel/tweens/FlxEase.hx",55,0x71810bf2)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(55)
	return ((int)1 + ((--(t) * t) * t));
}
...
Float FlxEase_obj::quartOut( Float t){
	HX_STACK_FRAME("flixel.tweens.FlxEase","quartOut",0xd3afb411,"flixel.tweens.FlxEase.quartOut","flixel/tweens/FlxEase.hx",70,0x71810bf2)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(70)
...
Float FlxEase_obj::quintOut( Float t){
	HX_STACK_FRAME("flixel.tweens.FlxEase","quintOut",0xb8f04505,"flixel.tweens.FlxEase.quintOut","flixel/tweens/FlxEase.hx",85,0x71810bf2)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(85)
...
Float FlxEase_obj::quintInOut( Float t){
	HX_STACK_FRAME("flixel.tweens.FlxEase","quintInOut",0x902ba9e0,"flixel.tweens.FlxEase.quintInOut","flixel/tweens/FlxEase.hx",90,0x71810bf2)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(90)
...
Float FlxEase_obj::sineIn( Float t){
	HX_STACK_FRAME("flixel.tweens.FlxEase","sineIn",0xb7fda354,"flixel.tweens.FlxEase.sineIn","flixel/tweens/FlxEase.hx",95,0x71810bf2)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(95)
...
Float FlxEase_obj::sineInOut( Float t){
	HX_STACK_FRAME("flixel.tweens.FlxEase","sineInOut",0x99ac819a,"flixel.tweens.FlxEase.sineInOut","flixel/tweens/FlxEase.hx",105,0x71810bf2)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(105)
...
Float FlxEase_obj::circIn( Float t){
	HX_STACK_FRAME("flixel.tweens.FlxEase","circIn",0x54eb335e,"flixel.tweens.FlxEase.circIn","flixel/tweens/FlxEase.hx",144,0x71810bf2)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(144)
...
Float FlxEase_obj::expoOut( Float t){
	HX_STACK_FRAME("flixel.tweens.FlxEase","expoOut",0x2c8d107a,"flixel.tweens.FlxEase.expoOut","flixel/tweens/FlxEase.hx",164,0x71810bf2)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(164)
	return (-(::Math_obj::pow((int)2,((int)-10 * t))) + (int)1);
}
...
Float FlxEase_obj::backOut( Float t){
	HX_STACK_FRAME("flixel.tweens.FlxEase","backOut",0xfebcfaa5,"flixel.tweens.FlxEase.backOut","flixel/tweens/FlxEase.hx",179,0x71810bf2)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(179)
...
Float FlxEase_obj::elasticIn( Float t){
	...
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(192)
	Float _g = (::flixel::tweens::FlxEase_obj::ELASTIC_AMPLITUDE * ::Math_obj::pow((int)2,((int)10 * (hx::SubEq(t,(int)1)))));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(192)
	return -(((_g * ::Math_obj::sin((Float((((t - ((Float(::flixel::tweens::FlxEase_obj::ELASTIC_PERIOD) / Float((((int)2 * ::Math_obj::PI)))) * ::Math_obj::asin((Float((int)1) / Float(::flixel::tweens::FlxEase_obj::ELASTIC_AMPLITUDE)))))) * (((int)2 * ::Math_obj::PI)))) / Float(::flixel::tweens::FlxEase_obj::ELASTIC_PERIOD))))));
}
...
Float FlxEase_obj::elasticOut( Float t){
	...
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(197)
	Float _g = (::flixel::tweens::FlxEase_obj::ELASTIC_AMPLITUDE * ::Math_obj::pow((int)2,((int)-10 * t)));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(197)
	return ((_g * ::Math_obj::sin((Float((((t - ((Float(::flixel::tweens::FlxEase_obj::ELASTIC_PERIOD) / Float((((int)2 * ::Math_obj::PI)))) * ::Math_obj::asin((Float((int)1) / Float(::flixel::tweens::FlxEase_obj::ELASTIC_AMPLITUDE)))))) * (((int)2 * ::Math_obj::PI)))) / Float(::flixel::tweens::FlxEase_obj::ELASTIC_PERIOD)))) + (int)1);
}
...
Float FlxEase_obj::elasticInOut( Float t){
	...
	if (((t < 0.5))){
		HX_STACK_LINE(204)
		Float _g = ::Math_obj::pow((int)2,((int)10 * (hx::SubEq(t,0.5))));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(204)
		return (-0.5 * ((_g * ::Math_obj::sin((Float((((t - (Float(::flixel::tweens::FlxEase_obj::ELASTIC_PERIOD) / Float((int)4)))) * (((int)2 * ::Math_obj::PI)))) / Float(::flixel::tweens::FlxEase_obj::ELASTIC_PERIOD))))));
	}
	HX_STACK_LINE(206)
	Float _g1 = ::Math_obj::pow((int)2,((int)-10 * (hx::SubEq(t,0.5))));		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(206)
	return (((_g1 * ::Math_obj::sin((Float((((t - (Float(::flixel::tweens::FlxEase_obj::ELASTIC_PERIOD) / Float((int)4)))) * (((int)2 * ::Math_obj::PI)))) / Float(::flixel::tweens::FlxEase_obj::ELASTIC_PERIOD)))) * 0.5) + (int)1);
}
