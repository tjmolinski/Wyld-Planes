...
{
		HX_STACK_FRAME("flixel.FlxState","openSubState",0x3d5ea838,"flixel.FlxState.openSubState","flixel/FlxState.hx",80,0xdf96844c)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.FlxState","closeSubState",0x519577cc,"flixel.FlxState.closeSubState","flixel/FlxState.hx",89,0xdf96844c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(90)
		this->_requestSubStateReset = true;
		HX_STACK_LINE(91)
...
{
		HX_STACK_FRAME("flixel.FlxState","resetSubState",0x772d18e3,"flixel.FlxState.resetSubState","flixel/FlxState.hx",98,0xdf96844c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(100)
		if (((this->subState != null()))){
			HX_STACK_LINE(102)
...
{
		HX_STACK_FRAME("flixel.FlxState","destroy",0x2171383d,"flixel.FlxState.destroy","flixel/FlxState.hx",133,0xdf96844c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(134)
		if (((this->subState != null()))){
			HX_STACK_LINE(136)
...
{
		HX_STACK_FRAME("flixel.FlxState","onFocusLost",0x8c2b4d80,"flixel.FlxState.onFocusLost","flixel/FlxState.hx",146,0xdf96844c)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("flixel.FlxState","onFocus",0x97b2097c,"flixel.FlxState.onFocus","flixel/FlxState.hx",152,0xdf96844c)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("flixel.FlxState","onResize",0x38e71fd0,"flixel.FlxState.onResize","flixel/FlxState.hx",160,0xdf96844c)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.FlxState","tryUpdate",0xc75023a7,"flixel.FlxState.tryUpdate","flixel/FlxState.hx",164,0xdf96844c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(165)
