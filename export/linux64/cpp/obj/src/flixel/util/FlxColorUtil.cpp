...
Float Alpha = __o_Alpha.Default(1.0);
	HX_STACK_FRAME("flixel.util.FlxColorUtil","makeFromHSBA",0xdd3e8f63,"flixel.util.FlxColorUtil.makeFromHSBA","flixel/util/FlxColorUtil.hx",33,0x18d3ded1)
...
Dynamic FlxColorUtil_obj::getARGB( int Color,Dynamic Results){
	HX_STACK_FRAME("flixel.util.FlxColorUtil","getARGB",0xf9594d21,"flixel.util.FlxColorUtil.getARGB","flixel/util/FlxColorUtil.hx",102,0x18d3ded1)
	...
	if (((Results != null()))){
		struct _Function_2_1{
			inline static Dynamic Block( int &red,int &green,int &blue,Float &alpha){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",109,0x18d3ded1)
				{
	...
	struct _Function_1_1{
		inline static Dynamic Block( int &red,int &green,int &blue,Float &alpha){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",112,0x18d3ded1)
			{
				hx::Anon __result = hx::Anon_obj::Create();
				__result->Add(HX_CSTRING("red") , red,false);
				__result->Add(HX_CSTRING("green") , green,false);
...
Dynamic FlxColorUtil_obj::getHSBA( int Color,Dynamic Results){
	HX_STACK_FRAME("flixel.util.FlxColorUtil","getHSBA",0xfdfa895f,"flixel.util.FlxColorUtil.getHSBA","flixel/util/FlxColorUtil.hx",125,0x18d3ded1)
	HX_STACK_ARG(Color,"Color")
	HX_STACK_ARG(Results,"Results")
	HX_STACK_LINE(126)
	...
	if (((Results != null()))){
		struct _Function_2_1{
			inline static Dynamic Block( Float &brightness,Float &saturation,Float &alpha,Float &hue){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",173,0x18d3ded1)
				{
					hx::Anon __result = hx::Anon_obj::Create();
	...
	struct _Function_1_1{
		inline static Dynamic Block( Float &brightness,Float &saturation,Float &alpha,Float &hue){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",175,0x18d3ded1)
			{
				hx::Anon __result = hx::Anon_obj::Create();
				__result->Add(HX_CSTRING("hue") , ::Std_obj::_int(hue),false);
				__result->Add(HX_CSTRING("brightness") , brightness,false);
...
Float FlxColorUtil_obj::getAlphaFloat( int Color){
	HX_STACK_FRAME("flixel.util.FlxColorUtil","getAlphaFloat",0x73402313,"flixel.util.FlxColorUtil.getAlphaFloat","flixel/util/FlxColorUtil.hx",196,0x18d3ded1)
	HX_STACK_ARG(Color,"Color")
	HX_STACK_LINE(197)
...
int Alpha = __o_Alpha.Default(255);
	HX_STACK_FRAME("flixel.util.FlxColorUtil","getHSVColorWheel",0xcbde148e,"flixel.util.FlxColorUtil.getHSVColorWheel","flixel/util/FlxColorUtil.hx",282,0x18d3ded1)
	HX_STACK_ARG(Alpha,"Alpha")
{
		HX_STACK_LINE(283)
...
int FlxColorUtil_obj::getComplementHarmony( int Color){
	HX_STACK_FRAME("flixel.util.FlxColorUtil","getComplementHarmony",0x5b6ab0ab,"flixel.util.FlxColorUtil.getComplementHarmony","flixel/util/FlxColorUtil.hx",302,0x18d3ded1)
	HX_STACK_ARG(Color,"Color")
	HX_STACK_LINE(303)
...
int Threshold = __o_Threshold.Default(30);
	HX_STACK_FRAME("flixel.util.FlxColorUtil","getAnalogousHarmony",0xbd99d09e,"flixel.util.FlxColorUtil.getAnalogousHarmony","flixel/util/FlxColorUtil.hx",319,0x18d3ded1)
	HX_STACK_ARG(Color,"Color")
	HX_STACK_ARG(Threshold,"Threshold")
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( int &_g1,int &warmer,int &_g,Dynamic &hsv,int &Color,int &colder){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",330,0x18d3ded1)
				{
					hx::Anon __result = hx::Anon_obj::Create();
...
int Threshold = __o_Threshold.Default(30);
	HX_STACK_FRAME("flixel.util.FlxColorUtil","getSplitComplementHarmony",0xad902ebb,"flixel.util.FlxColorUtil.getSplitComplementHarmony","flixel/util/FlxColorUtil.hx",343,0x18d3ded1)
	HX_STACK_ARG(Color,"Color")
	HX_STACK_ARG(Threshold,"Threshold")
{
		HX_STACK_LINE(344)
		...
		struct _Function_1_1{
			inline static Dynamic Block( int &_g1,int &warmer,int &_g,Dynamic &hsv,int &Color,int &colder){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",358,0x18d3ded1)
				{
					hx::Anon __result = hx::Anon_obj::Create();
					__result->Add(HX_CSTRING("color1") , Color,false);
					__result->Add(HX_CSTRING("color2") , _g,false);
...
Dynamic FlxColorUtil_obj::getTriadicHarmony( int Color){
	HX_STACK_FRAME("flixel.util.FlxColorUtil","getTriadicHarmony",0xae2336f3,"flixel.util.FlxColorUtil.getTriadicHarmony","flixel/util/FlxColorUtil.hx",369,0x18d3ded1)
	HX_STACK_ARG(Color,"Color")
	HX_STACK_LINE(370)
	Dynamic hsv = ::flixel::util::FlxColorUtil_obj::RGBtoHSV(Color);		HX_STACK_VAR(hsv,"hsv");
	HX_STACK_LINE(372)
	...
	struct _Function_1_1{
		inline static Dynamic Block( int &_g,int &Color,int &triadic2){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",375,0x18d3ded1)
			{
				hx::Anon __result = hx::Anon_obj::Create();
				__result->Add(HX_CSTRING("color1") , Color,false);
				__result->Add(HX_CSTRING("color2") , _g,false);
...
::String FlxColorUtil_obj::getColorInfo( int Color){
	HX_STACK_FRAME("flixel.util.FlxColorUtil","getColorInfo",0x261c275c,"flixel.util.FlxColorUtil.getColorInfo","flixel/util/FlxColorUtil.hx",386,0x18d3ded1)
	HX_STACK_ARG(Color,"Color")
	HX_STACK_LINE(387)
	...
	HX_STACK_LINE(387)
	{
		...
		if (((Results != null()))){
			struct _Function_3_1{
				inline static Dynamic Block( int &red,int &green,int &blue,Float &alpha){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",387,0x18d3ded1)
					{
						hx::Anon __result = hx::Anon_obj::Create();
						__result->Add(HX_CSTRING("red") , red,false);
						__result->Add(HX_CSTRING("green") , green,false);
	...
	struct _Function_1_1{
		inline static ::String Block( int &Color){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",391,0x18d3ded1)
			{
				HX_STACK_LINE(391)
...
::String FlxColorUtil_obj::ARGBtoHexString( int Color){
	HX_STACK_FRAME("flixel.util.FlxColorUtil","ARGBtoHexString",0x26500a84,"flixel.util.FlxColorUtil.ARGBtoHexString","flixel/util/FlxColorUtil.hx",409,0x18d3ded1)
	HX_STACK_ARG(Color,"Color")
	HX_STACK_LINE(410)
	Dynamic argb;		HX_STACK_VAR(argb,"argb");
	HX_STACK_LINE(410)
	{
		...
		if (((Results != null()))){
			struct _Function_3_1{
				inline static Dynamic Block( int &red,int &green,int &blue,Float &alpha){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",410,0x18d3ded1)
					{
						hx::Anon __result = hx::Anon_obj::Create();
						__result->Add(HX_CSTRING("red") , red,false);
						__result->Add(HX_CSTRING("green") , green,false);
...
::String FlxColorUtil_obj::ARGBtoWebString( int Color){
	HX_STACK_FRAME("flixel.util.FlxColorUtil","ARGBtoWebString",0xef9cfcfd,"flixel.util.FlxColorUtil.ARGBtoWebString","flixel/util/FlxColorUtil.hx",421,0x18d3ded1)
	HX_STACK_ARG(Color,"Color")
	HX_STACK_LINE(422)
	Dynamic argb;		HX_STACK_VAR(argb,"argb");
	HX_STACK_LINE(422)
	{
		...
		if (((Results != null()))){
			struct _Function_3_1{
				inline static Dynamic Block( int &red,int &green,int &blue,Float &alpha){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",422,0x18d3ded1)
					{
						hx::Anon __result = hx::Anon_obj::Create();
						__result->Add(HX_CSTRING("red") , red,false);
						__result->Add(HX_CSTRING("green") , green,false);
...
::String FlxColorUtil_obj::colorToHexString( int Color){
	HX_STACK_FRAME("flixel.util.FlxColorUtil","colorToHexString",0x245f204f,"flixel.util.FlxColorUtil.colorToHexString","flixel/util/FlxColorUtil.hx",433,0x18d3ded1)
	HX_STACK_ARG(Color,"Color")
	HX_STACK_LINE(434)
	::String digits = HX_CSTRING("0123456789ABCDEF");		HX_STACK_VAR(digits,"digits");
	HX_STACK_LINE(436)
...
int Alpha = __o_Alpha.Default(255);
	HX_STACK_FRAME("flixel.util.FlxColorUtil","HSVtoARGB",0x9ebb4371,"flixel.util.FlxColorUtil.HSVtoARGB","flixel/util/FlxColorUtil.hx",452,0x18d3ded1)
	HX_STACK_ARG(H,"H")
	HX_STACK_ARG(S,"S")
	HX_STACK_ARG(V,"V")
	HX_STACK_ARG(Alpha,"Alpha")
...
Dynamic FlxColorUtil_obj::RGBtoHSV( int Color){
	HX_STACK_FRAME("flixel.util.FlxColorUtil","RGBtoHSV",0x16e67524,"flixel.util.FlxColorUtil.RGBtoHSV","flixel/util/FlxColorUtil.hx",496,0x18d3ded1)
	HX_STACK_ARG(Color,"Color")
	HX_STACK_LINE(497)
	...
	HX_STACK_LINE(497)
	{
		...
		if (((Results != null()))){
			struct _Function_3_1{
				inline static Dynamic Block( int &red,int &green,int &blue,Float &alpha){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",497,0x18d3ded1)
					{
						hx::Anon __result = hx::Anon_obj::Create();
						__result->Add(HX_CSTRING("red") , red,false);
						__result->Add(HX_CSTRING("green") , green,false);
	...
	struct _Function_1_1{
		inline static Dynamic Block( Float &saturation,Float &lightness,Float &hue){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",559,0x18d3ded1)
			{
				hx::Anon __result = hx::Anon_obj::Create();
...
int Alpha = __o_Alpha.Default(255);
	HX_STACK_FRAME("flixel.util.FlxColorUtil","interpolateColor",0xc761bcc3,"flixel.util.FlxColorUtil.interpolateColor","flixel/util/FlxColorUtil.hx",585,0x18d3ded1)
	...
	HX_STACK_ARG(Alpha,"Alpha")
{
		...
		HX_STACK_LINE(586)
		{
			...
			if (((Results != null()))){
				struct _Function_3_1{
					inline static Dynamic Block( int &red,int &green,int &blue,Float &alpha){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",586,0x18d3ded1)
						{
							hx::Anon __result = hx::Anon_obj::Create();
							__result->Add(HX_CSTRING("red") , red,false);
							__result->Add(HX_CSTRING("green") , green,false);
...
int FlxColorUtil_obj::interpolateColorWithRGB( int Color,int R2,int G2,int B2,int Steps,int CurrentStep){
	HX_STACK_FRAME("flixel.util.FlxColorUtil","interpolateColorWithRGB",0x20b6e224,"flixel.util.FlxColorUtil.interpolateColorWithRGB","flixel/util/FlxColorUtil.hx",609,0x18d3ded1)
	HX_STACK_ARG(Color,"Color")
	HX_STACK_ARG(R2,"R2")
	HX_STACK_ARG(G2,"G2")
	HX_STACK_ARG(B2,"B2")
	...
	HX_STACK_LINE(610)
	{
		...
		if (((Results != null()))){
			struct _Function_3_1{
				inline static Dynamic Block( int &red,int &green,int &blue,Float &alpha){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",610,0x18d3ded1)
					{
						hx::Anon __result = hx::Anon_obj::Create();
						__result->Add(HX_CSTRING("red") , red,false);
						__result->Add(HX_CSTRING("green") , green,false);
...
int FlxColorUtil_obj::interpolateRGB( int R1,int G1,int B1,int R2,int G2,int B2,int Steps,int CurrentStep){
	HX_STACK_FRAME("flixel.util.FlxColorUtil","interpolateRGB",0xb900726d,"flixel.util.FlxColorUtil.interpolateRGB","flixel/util/FlxColorUtil.hx",634,0x18d3ded1)
	HX_STACK_ARG(R1,"R1")
	HX_STACK_ARG(G1,"G1")
	HX_STACK_ARG(B1,"B1")
	HX_STACK_ARG(R2,"R2")
...
Float Factor = __o_Factor.Default(0.2);
	HX_STACK_FRAME("flixel.util.FlxColorUtil","darken",0xce754f00,"flixel.util.FlxColorUtil.darken","flixel/util/FlxColorUtil.hx",650,0x18d3ded1)
	HX_STACK_ARG(Color,"Color")
...
Float Factor = __o_Factor.Default(0.2);
	HX_STACK_FRAME("flixel.util.FlxColorUtil","brighten",0xbd5f0604,"flixel.util.FlxColorUtil.brighten","flixel/util/FlxColorUtil.hx",675,0x18d3ded1)
	HX_STACK_ARG(Color,"Color")
	HX_STACK_ARG(Factor,"Factor")
{
		HX_STACK_LINE(676)
