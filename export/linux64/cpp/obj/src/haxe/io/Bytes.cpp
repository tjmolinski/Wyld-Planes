...
::String Bytes_obj::readString( int pos,int len){
	HX_STACK_FRAME("haxe.io.Bytes","readString",0x5f58954a,"haxe.io.Bytes.readString","/usr/lib/haxe/std/haxe/io/Bytes.hx",180,0x9329f754)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pos,"pos")
	HX_STACK_ARG(len,"len")
	HX_STACK_LINE(182)
...
::String Bytes_obj::toString( ){
	HX_STACK_FRAME("haxe.io.Bytes","toString",0x0291226f,"haxe.io.Bytes.toString","/usr/lib/haxe/std/haxe/io/Bytes.hx",245,0x9329f754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(245)
