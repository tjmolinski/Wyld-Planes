...
Dynamic Unserializer_obj::unserializeEnum( ::Enum edecl,::String tag){
	...
	struct _Function_1_1{
		inline static int Block( ::haxe::Unserializer_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/haxe/Unserializer.hx",188,0xcde24acb)
			{
				HX_STACK_LINE(188)
				int p = (__this->pos)++;		HX_STACK_VAR(p,"p");
				HX_STACK_LINE(188)
				return __this->buf.cca(p);
			}
			return null();
		}
	};
	HX_STACK_LINE(188)
	if (((_Function_1_1::Block(this) != (int)58))){
		HX_STACK_LINE(189)
...
Dynamic Unserializer_obj::unserialize( ){
		...
		switch( (int)(_g)){
			...
			case (int)121: {
				...
				struct _Function_3_1{
					inline static int Block( ::haxe::Unserializer_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/haxe/Unserializer.hx",244,0xcde24acb)
						{
							HX_STACK_LINE(244)
							int p = (__this->pos)++;		HX_STACK_VAR(p,"p");
							HX_STACK_LINE(244)
				...
				HX_STACK_LINE(244)
				if (((  ((!(((_Function_3_1::Block(this) != (int)58))))) ? bool(((this->length - this->pos) < len)) : bool(true) ))){
					HX_STACK_LINE(245)
			...
			case (int)115: {
				...
				struct _Function_3_1{
					inline static int Block( ::haxe::Unserializer_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/haxe/Unserializer.hx",371,0xcde24acb)
						{
							HX_STACK_LINE(371)
							int p = (__this->pos)++;		HX_STACK_VAR(p,"p");
							HX_STACK_LINE(371)
				...
				while(((i < max))){
					struct _Function_4_1{
						inline static int Block( int &i,::String &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/haxe/Unserializer.hx",388,0xcde24acb)
							{
								HX_STACK_LINE(388)
								int index = (i)++;		HX_STACK_VAR(index,"index");
								HX_STACK_LINE(388)
								return buf.cca(index);
							}
							return null();
						}
					};
					HX_STACK_LINE(388)
					int c1 = codes->__get(_Function_4_1::Block(i,buf));		HX_STACK_VAR(c1,"c1");
					struct _Function_4_2{
						inline static int Block( int &i,::String &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/haxe/Unserializer.hx",389,0xcde24acb)
							{
								HX_STACK_LINE(389)
								int index = (i)++;		HX_STACK_VAR(index,"index");
								HX_STACK_LINE(389)
					...
					HX_STACK_LINE(389)
					int c2 = codes->__get(_Function_4_2::Block(i,buf));		HX_STACK_VAR(c2,"c2");
					HX_STACK_LINE(390)
					{
						HX_STACK_LINE(390)
					...
					struct _Function_4_3{
						inline static int Block( int &i,::String &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/haxe/Unserializer.hx",391,0xcde24acb)
							{
								HX_STACK_LINE(391)
								int index = (i)++;		HX_STACK_VAR(index,"index");
								HX_STACK_LINE(391)
					...
					HX_STACK_LINE(391)
					int c3 = codes->__get(_Function_4_3::Block(i,buf));		HX_STACK_VAR(c3,"c3");
					HX_STACK_LINE(392)
					{
						HX_STACK_LINE(392)
						int pos = (bpos)++;		HX_STACK_VAR(pos,"pos");
					...
					struct _Function_4_4{
						inline static int Block( int &i,::String &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/haxe/Unserializer.hx",393,0xcde24acb)
							{
								HX_STACK_LINE(393)
								int index = (i)++;		HX_STACK_VAR(index,"index");
								HX_STACK_LINE(393)
					...
					HX_STACK_LINE(393)
					int c4 = codes->__get(_Function_4_4::Block(i,buf));		HX_STACK_VAR(c4,"c4");
					HX_STACK_LINE(394)
					{
						HX_STACK_LINE(394)
						int pos = (bpos)++;		HX_STACK_VAR(pos,"pos");
				...
				if (((rest >= (int)2))){
					struct _Function_4_1{
						inline static int Block( int &i,::String &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/haxe/Unserializer.hx",397,0xcde24acb)
							{
								HX_STACK_LINE(397)
								int index = (i)++;		HX_STACK_VAR(index,"index");
								HX_STACK_LINE(397)
					...
					struct _Function_4_2{
						inline static int Block( int &i,::String &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/haxe/Unserializer.hx",398,0xcde24acb)
							{
								HX_STACK_LINE(398)
								int index = (i)++;		HX_STACK_VAR(index,"index");
								HX_STACK_LINE(398)
					...
					if (((rest == (int)3))){
						struct _Function_5_1{
							inline static int Block( int &i,::String &buf){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/haxe/Unserializer.hx",401,0xcde24acb)
								{
									HX_STACK_LINE(401)
									int index = (i)++;		HX_STACK_VAR(index,"index");
									HX_STACK_LINE(401)
						...
						HX_STACK_LINE(401)
						int c3 = codes->__get(_Function_5_1::Block(i,buf));		HX_STACK_VAR(c3,"c3");
						HX_STACK_LINE(402)
						{
							HX_STACK_LINE(402)
							int pos = (bpos)++;		HX_STACK_VAR(pos,"pos");
			...
			case (int)67: {
				...
				struct _Function_3_1{
					inline static int Block( ::haxe::Unserializer_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/haxe/Unserializer.hx",417,0xcde24acb)
						{
							HX_STACK_LINE(417)
							int p = (__this->pos)++;		HX_STACK_VAR(p,"p");
							HX_STACK_LINE(417)
				...
				HX_STACK_LINE(417)
				if (((_Function_3_1::Block(this) != (int)103))){
					HX_STACK_LINE(418)
	...
	(this->pos)--;
	HX_STACK_LINE(423)
	HX_STACK_DO_THROW((((HX_CSTRING("Invalid char ") + this->buf.charAt(this->pos)) + HX_CSTRING(" at position ")) + this->pos));
	HX_STACK_LINE(423)
	return null();
}
