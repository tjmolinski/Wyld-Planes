...
{
		HX_STACK_FRAME("haxe.format.JsonParser","invalidNumber",0x8e9d1988,"haxe.format.JsonParser.invalidNumber","/usr/lib/haxe/std/haxe/format/JsonParser.hx",208,0x2ab73747)
		HX_STACK_THIS(this)
