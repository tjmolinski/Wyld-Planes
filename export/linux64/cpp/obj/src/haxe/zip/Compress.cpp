...
{
HX_STACK_FRAME("haxe.zip.Compress","new",0x4ddc50a9,"haxe.zip.Compress.new","/usr/lib/haxe/std/cpp/_std/haxe/zip/Compress.hx",30,0x8f1f5343)

HX_STACK_ARG(level,"level")
{
	HX_STACK_LINE(30)
	this->s = ::haxe::zip::Compress_obj::_deflate_init(level);
}
;
	return null();
}
...
{
		HX_STACK_FRAME("haxe.zip.Compress","setFlushMode",0x35ab82dc,"haxe.zip.Compress.setFlushMode","/usr/lib/haxe/std/cpp/_std/haxe/zip/Compress.hx",38,0x8f1f5343)
		HX_STACK_THIS(this)
		HX_STACK_ARG(f,"f")
		HX_STACK_LINE(38)
		::haxe::zip::Compress_obj::_set_flush_mode(this->s,::Std_obj::string(f));
	}
return null();
}
...
::haxe::io::Bytes Compress_obj::run( ::haxe::io::Bytes s,int level){
	...
	HX_STACK_LINE(48)
	::haxe::io::Bytes out = ::haxe::io::Bytes_obj::alloc(::haxe::zip::Compress_obj::_deflate_bound(c->s,s->length));		HX_STACK_VAR(out,"out");
	HX_STACK_LINE(49)
