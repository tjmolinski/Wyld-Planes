...
{
HX_STACK_FRAME("haxe.zip.Uncompress","new",0x34f307c2,"haxe.zip.Uncompress.new","/usr/lib/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",29,0x466e914a)

HX_STACK_ARG(windowBits,"windowBits")
{
	HX_STACK_LINE(29)
	this->s = ::haxe::zip::Uncompress_obj::_inflate_init(windowBits);
}
;
	return null();
}
...
{
		HX_STACK_FRAME("haxe.zip.Uncompress","setFlushMode",0xbecba0a3,"haxe.zip.Uncompress.setFlushMode","/usr/lib/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",37,0x466e914a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(f,"f")
		HX_STACK_LINE(37)
		::haxe::zip::Uncompress_obj::_set_flush_mode(this->s,f->__Tag());
	}
return null();
}
