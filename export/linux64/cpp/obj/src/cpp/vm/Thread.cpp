...
::cpp::vm::Thread Thread_obj::current( ){
	HX_STACK_FRAME("cpp.vm.Thread","current",0x21a37c01,"cpp.vm.Thread.current","/usr/lib/haxe/std/cpp/vm/Thread.hx",46,0x4b517dc9)
	HX_STACK_LINE(46)
...
::cpp::vm::Thread Thread_obj::create( Dynamic callb){
	HX_STACK_FRAME("cpp.vm.Thread","create",0xb01a9834,"cpp.vm.Thread.create","/usr/lib/haxe/std/cpp/vm/Thread.hx",53,0x4b517dc9)
